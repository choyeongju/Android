        ...
        ActivityResultLauncher<Intent> launcher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(),
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult o) {
                        ...
                        binding.jointhemembershopChoiceDepartmentButton.setText(o.getData().getStringExtra("result"));
                        showToast(join_department + " 선택");

                    }
                });

        binding.jointhemembershopChoiceDepartmentButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
            ...
            public void onClick(View v) {
                ...
                if (checkID == false){
                    ...
                    user = new User(ID, PW, binding.PWHintBtn.getText().toString(), binding.PWHintInputbox.getText().toString(),
                            join_department, binding.Nickinputbox.getText().toString(), temp);
                    addData(user);
                    Log.d("SSU", "회원가입 성공");
                    signUp(ID, PW);
                }
