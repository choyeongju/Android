...
public class TableAdapter extends RecyclerView.Adapter<TableViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TableViewHolder holder, int position) {
        ...
        if (tableRow.getTitle1() == null) {
            holder.tablebinding.tableSample1.setVisibility(View.INVISIBLE);
            holder.tablebinding.tableSample1.setClickable(false);
        }
        else
            holder.tablebinding.tableSample1.setText(tableRow.getTitle1());
        if (tableRow.getTitle2() == null) {
            holder.tablebinding.tableSample2.setVisibility(View.INVISIBLE);
            holder.tablebinding.tableSample2.setClickable(false);
        }
        else
            holder.tablebinding.tableSample2.setText(tableRow.getTitle2());
        if (tableRow.getTitle3() == null) {
            holder.tablebinding.tableSample3.setVisibility(View.INVISIBLE);
            holder.tablebinding.tableSample3.setClickable(false);
        }
        else
